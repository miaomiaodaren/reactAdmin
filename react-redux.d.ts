//https://github.com/ServiceStackApps/typescript-redux/blob/master/src/TypeScriptRedux/typings/main/ambient/react-redux/react-redux.d.ts
//typescript-redux 配置文件里面应该都有
